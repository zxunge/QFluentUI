...
FluDropDownButton::FluDropDownButton(QWidget *parent /*= nullptr*/)
    : FluWidget(parent), m_svgDarkPath(""), m_svgLightPath("")
{
...
void FluDropDownButton::onThemeChanged()
{
    if (FluThemeUtils::isLightTheme()) {
        m_iconBtn->setIcon(
                FluIconUtils::getFluentIcon(FluAwesomeType::ChevronDown, FluTheme::Light));
        ...
        m_iconBtn->setIcon(
                FluIconUtils::getFluentIcon(FluAwesomeType::ChevronDown, FluTheme::Dark));
        if (m_textAwesomeType != FluAwesomeType::None)
    ...
    FluStyleSheetUitls::setQssByFileName("FluDropDownButton.qss", this,
