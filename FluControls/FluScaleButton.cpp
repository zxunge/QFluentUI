...
FluScaleButton::FluScaleButton(FluAwesomeType awesomeType, QWidget *parent /*= nullptr*/)
    : QPushButton(parent), m_iconType(awesomeType)
{
    setFixedSize(30, 30);
    m_bPressed = false;
...
void FluScaleButton::scaleByPercentage(float scale)
{
    ...
    QPixmap pixmap =
            FluIconUtils::getFluentIconPixmap(m_iconType, FluThemeUtils::getUtils()->getTheme());
...
{
    scaleByPercentage(m_currentPercentage);
    FluStyleSheetUitls::setQssByFileName("FluScaleButton.qss", this,
