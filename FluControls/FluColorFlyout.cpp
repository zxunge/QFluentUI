...
FluColorFlyout::FluColorFlyout(QWidget *targetWidget)
    : FluWidget(nullptr), m_targetWidget(targetWidget)
{
    // LOG_DEBUG << "called";
...
{
    FluStyleSheetUitls::setQssByFileName("FluColorFlyout.qss", this,
