...
FluAppBarToggleButton::FluAppBarToggleButton(FluAwesomeType awesomeType,
                                             QWidget *parent /*= nullptr*/)
    : FluWidget(parent), m_awesomeType(awesomeType), m_bToggled(false)
{
...
{
    FluStyleSheetUitls::setQssByFileName("FluAppBarToggleButton.qss", this,
