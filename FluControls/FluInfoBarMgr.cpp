...
void FluInfoBarMgr::showInfoBar(QWidget *parentWidget, FluShortInfoBarType type, QString text,
                               ...
                               int nDisappearDuration /* = 2000*/)
{
    ...
    if (itf == m_infoBarMap.end()) {
        ...
        // LOG_DEBUG << "parentWidget Width:" << parentWidget->width() << ", infoBar width:" <<
        // infoBar->sizeHint().width();
        int nY = 75;
