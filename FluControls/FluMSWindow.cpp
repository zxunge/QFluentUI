...
void FluMSWindow::addWidget(FluAwesomeType awesomeType, QString text, QString key, QWidget *page,
                            FluMSNavigationItemPosition position)
{
    if (page == nullptr)
        return;
...
void FluMSWindow::onThemeChanged()
{
    ...
    FluStyleSheetUitls::setQssByFileName("FluMSWindow.qss", this,
