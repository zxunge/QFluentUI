...
public:
    ...
    std::vector<FluHNavigationIconTextItem *> getItems() { return m_items; }

    void getAllItems(std::vector<FluHNavigationIconTextItem *> &totalItems);

    std::vector<FluHNavigationIconTextItem *> getAllItems();

    QWidget *getWrapWidget1() { return m_wrapWidget1; }

    QWidget *getWrapWidget2() { return m_wrapWidget2; }

    QPushButton *getIconBtn() { return m_iconBtn; }

    QLabel *getLabel() { return m_label; }

    FluAwesomeType getAwesomeType() { return m_awesomeType; }

    QString getText() { return m_label->text(); }

    bool getHideIcon() { return m_bHideIcon; }

    void setHideIcon(bool bHideIcon) { m_bHideIcon = bHideIcon; }

    bool parentIsFlyIconTextItem() { return m_bParentIsFlyIconTextItem; }

    bool parentIsNavigationView() { return m_bParentIsNavigationView; }

    void setParentIsFlyIconTextItem(bool bParent) { m_bParentIsFlyIconTextItem = bParent; }
    ...
    FluHNavigationFlyIconTextItem *getParentFlyIconTextItem() { return m_parentFlyIconTextItem; }
    ...
    bool isLeaf() { return m_items.empty(); }
    ...
    QWidget *getVIndicator() { return m_vIndicator; }
