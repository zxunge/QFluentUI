...
FluHNavigationIconTextItem::FluHNavigationIconTextItem(QWidget *parent /*= nullptr*/)
    : FluHNavigationItem(parent)
{
    ...
    m_iconBtn->setIcon(FluIconUtils::getFluentIcon(FluAwesomeType::None,
...
FluHNavigationIconTextItem::FluHNavigationIconTextItem(FluAwesomeType awesomeType, QString text,
                                                       QWidget *parent /*= nullptr*/)
    : FluHNavigationIconTextItem(parent)
{
...
FluHNavigationIconTextItem::FluHNavigationIconTextItem(FluHNavigationIconTextItem *item)
...
FluHNavigationIconTextItem::FluHNavigationIconTextItem(QString text, QWidget *parent /*= nullptr*/)
    : FluHNavigationIconTextItem(parent)
{
    m_awesomeType = FluAwesomeType::None;
    m_iconBtn->hide();
...
int FluHNavigationIconTextItem::calcItemW1Width()
{
    ...
    // LOG_DEBUG << "W1 width:" << leftMargins + emptyWidgetWidth + nIndicatorWidth + nIconWidth +
    // nSpacing + nLabelWidth + nSpacing + nArrowWidth + nSpacing + rightMargins + 20;

    int nW1Width = leftMargins + emptyWidgetWidth + nIndicatorWidth + nIconWidth + nSpacing
            + nLabelWidth + nArrowWidth + rightMargins + 20;
                                                 ...
                                                 int &nCallHierarchy)
{
    ...
    // LOG_DEBUG << sHierarchy << "text:" << getText() << ", child item count:" <<
    // item->m_vLayout1->count();
        ...
        if (!getItems().empty()) {
            ...
            if (m_bDown) {
                ...
                connect(flyIconTextItem, &FluHNavigationFlyIconTextItem::itemClose, this, [=]() {
                    ...
                    bool bOnItem =
                            geometry().contains(parentWidget()->mapFromGlobal(QCursor::pos()));
...
void FluHNavigationIconTextItem::onThemeChanged()
{
    if (FluThemeUtils::isLightTheme()) {
        ...
        // FluStyleSheetUitls::setQssByFileName("../StyleSheet/light/FluHNavigationIconTextItem.qss",
        // this);
        setArrowBtnToChevronDown();
    } else {
        m_iconBtn->setIcon(FluIconUtils::getFluentIcon(m_awesomeType, FluTheme::Dark));
        // FluStyleSheetUitls::setQssByFileName("../StyleSheet/dark/FluHNavigationIconTextItem.qss",
        // this);
        setArrowBtnToChevronUp();
    }
    FluStyleSheetUitls::setQssByFileName("FluHNavigationIconTextItem.qss", this,
                                         FluThemeUtils::getUtils()->getTheme());
}
