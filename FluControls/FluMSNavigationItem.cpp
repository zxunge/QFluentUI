...
FluMSNavigationItem::FluMSNavigationItem(QWidget *parent /*= nullptr*/)
...
FluMSNavigationItem::FluMSNavigationItem(FluAwesomeType awesomeType, QString text, QString key,
                                         QWidget *parent /*= nullptr*/)
    : FluMSNavigationItem(parent)
{
...
void FluMSNavigationItem::onThemeChanged()
{
    if (FluThemeUtils::isLightTheme()) {
        ...
        // FluStyleSheetUitls::setQssByFileName("../StyleSheet/light/FluMSNavigationItem.qss",
        // this);
    } else {
    ...
    FluStyleSheetUitls::setQssByFileName("FluMSNavigationItem.qss", this,
