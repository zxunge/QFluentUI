...
public:
    ...
    //      return QSize(120, 40);
    // }
    void setLastSelectedItem(FluHNavigationItem *item) { m_lastSelectedItem = item; }

    FluHNavigationItem *getLastSelectedItem() { return m_lastSelectedItem; }
    ...
    FluHNavigationFlyIconTextItem *getFlyIconTextIcon() { return m_FlyIconTextItem; }
