...
void FluHNavigationFlyIconTextItem::setIconTextItems(
        std::vector<FluHNavigationIconTextItem *> items)
{
    for (auto item : items) {
...
void FluHNavigationFlyIconTextItem::adjustItemWidth()
{
    ...
    setFixedWidth(nMaxWidth + m_vScrollView->getMainLayout()->contentsMargins().left()
                  + m_vScrollView->getMainLayout()->contentsMargins().right());
}
...
{
    FluStyleSheetUitls::setQssByFileName("FluHNavigationFlyIconTextItem.qss", m_vScrollView,
                                         FluThemeUtils::getUtils()->getTheme());
    FluStyleSheetUitls::setQssByFileName("FluHNavigationFlyIconTextItem.qss", this,
                                         FluThemeUtils::getUtils()->getTheme());
}
