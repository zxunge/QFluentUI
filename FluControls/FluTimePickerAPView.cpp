...
FluTimePickerAPView::FluTimePickerAPView(QWidget *parent /*= nullptr*/)
    : FluWidget(parent), m_bAm(true), m_hour(0), m_minute(0), m_bFirstShow(true), m_mask(nullptr)
{
...
void FluTimePickerAPView::onThemeChanged()
{
    if (FluThemeUtils::isLightTheme()) {
        ...
        // FluStyleSheetUitls::setQssByFileName("../StyleSheet/light/FluTimePickerAPView.qss",
        // this);
    } else {
    ...
    FluStyleSheetUitls::setQssByFileName("FluTimePickerAPView.qss", this,
