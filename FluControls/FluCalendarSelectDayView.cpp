...
FluCalendarViewWeakTitle::FluCalendarViewWeakTitle(QWidget *parent /*= nullptr*/)
    : FluWidget(parent)
{
    ...
    QList<QString> weekTexts = { tr("Su"), tr("Mo"), tr("Tu"), tr("We"),
                                 tr("Th"), tr("Fr"), tr("Sa") };
...
{
    FluStyleSheetUitls::setQssByFileName("FluCalendarViewWeakTitle.qss", this,
...
void FluCalendarMonthView::setYearMonth(int nYear, int nMonth)
{
    ...
    for (int i = 0; i < 42; i++) {
        ...
        if (date.day() == 1) {
            ...
            QList<QString> monthTexts = { tr("Jan"), tr("Feb"), tr("Mar"), tr("Apr"),
...
{
    FluStyleSheetUitls::setQssByFileName("FluCalendarMonthView.qss", this,
                                         FluThemeUtils::getUtils()->getTheme());
}

FluCalendarSelectDayView::FluCalendarSelectDayView(QWidget *parent /*= nullptr*/)
    : FluWidget(parent)
{
