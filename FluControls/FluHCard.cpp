...
FluHCard::FluHCard(QWidget *parent /*= nullptr*/) : FluWidget(parent)
{
    ...
    m_contextLabel->setText("An element that displays and controls an icon that animates when the "
                            "user interacts with the controls.");
...
FluHCard::FluHCard(QPixmap icon, QString titleText, QString contextText,
...
{
    FluStyleSheetUitls::setQssByFileName("FluHCard.qss", this,
