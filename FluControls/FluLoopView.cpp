...
FluLoopView::FluLoopView(int nFixedW /*= 80*/, QWidget *parent /*= nullptr*/)
    : QListWidget(parent), m_nFixedW(nFixedW)
{
...
void FluLoopView::onThemeChanged()
{
    if (FluThemeUtils::isLightTheme()) {
        m_scrollUpBtn->setIcon(
                QIcon(FluIconUtils::getFluentIcon(FluAwesomeType::CaretSolidUp, FluTheme::Light)));
        m_scrollDownBtn->setIcon(QIcon(
                FluIconUtils::getFluentIcon(FluAwesomeType::CaretSolidDown, FluTheme::Light)));
        //   FluStyleSheetUitls::setQssByFileName("../StyleSheet/light/FluLoopView.qss", this);
    } else {
        m_scrollUpBtn->setIcon(
                QIcon(FluIconUtils::getFluentIcon(FluAwesomeType::CaretSolidUp, FluTheme::Dark)));
        m_scrollDownBtn->setIcon(
                QIcon(FluIconUtils::getFluentIcon(FluAwesomeType::CaretSolidDown, FluTheme::Dark)));
        // FluStyleSheetUitls::setQssByFileName("../StyleSheet/dark/FluLoopView.qss", this);
    }
    FluStyleSheetUitls::setQssByFileName("FluLoopView.qss", this,
