...
FluVNavigationSettingsItem::FluVNavigationSettingsItem(QIcon icon, QString text,
    ...
    : FluVNavigationItem(parent)
{
    ...
    connect(this, &FluVNavigationSettingsItem::itemClicked, this,
            &FluVNavigationSettingsItem::onItemClicked);
}

FluVNavigationSettingsItem::FluVNavigationSettingsItem(FluAwesomeType awesomeType, QString text,
                                                       QWidget *parent)
    : FluVNavigationSettingsItem(QIcon(), text, parent)
{
    m_icon->setIcon(
            FluIconUtils::getFluentIcon(awesomeType, FluThemeUtils::getUtils()->getTheme()));
...
{
    FluStyleSheetUitls::setQssByFileName("FluVNavigationSettingsItem.qss", this,
