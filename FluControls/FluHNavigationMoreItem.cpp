...
FluHNavigationMoreItem::FluHNavigationMoreItem(QWidget *parent /*= nullptr*/)
...
void FluHNavigationMoreItem::onThemeChanged()
{
    if (FluThemeUtils::isLightTheme()) {
        ...
        // FluStyleSheetUitls::setQssByFileName("../StyleSheet/light/FluHNavigationMoreItem.qss",
        // this);
    } else {
        m_iconBtn->setIcon(FluIconUtils::getFluentIcon(FluAwesomeType::More, FluTheme::Dark));
        // FluStyleSheetUitls::setQssByFileName("../StyleSheet/dark/FluHNavigationMoreItem.qss",
        // this);
    }
    FluStyleSheetUitls::setQssByFileName("FluHNavigationMoreItem.qss", this,
