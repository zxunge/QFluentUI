...
QSize FluTableItemDelegate::sizeHint(const QStyleOptionViewItem &option,
...
QWidget *FluTableItemDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option,
                                            const QModelIndex &index) const
{
...
void FluTableItemDelegate::updateEditorGeometry(QWidget *editor, const QStyleOptionViewItem &option,
                                                const QModelIndex &index) const
{
...
void FluTableItemDelegate::initStyleOption(QStyleOptionViewItem *option,
                                           const QModelIndex &index) const
{
...
void FluTableItemDelegate::drawSelfIndicator(QPainter *painter, const QStyleOptionViewItem &option,
                                             const QModelIndex &index) const
{
...
void FluTableItemDelegate::drawSelfBackground(QPainter *painter, const QStyleOptionViewItem &option,
                                              const QModelIndex &index) const
{
    int nR = 5;
    if (index.column() == 0) {
...
void FluTableItemDelegate::drawSelfCheckBox(QPainter *painter, const QStyleOptionViewItem &option,
                                            const QModelIndex &index) const
{
    painter->save();
...
void FluTableItemDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option,
                                 const QModelIndex &index) const
{
    ...
    bool bSelected = std::find(m_selectedRows.begin(), m_selectedRows.end(), index.row())
            != m_selectedRows.end();
