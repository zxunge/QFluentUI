...
void FluBorder::updateProperty(QString textColor, QString bgColor, QString borderWidth,
                               QString borderColor)
{
    ...
    FluStyleSheetUitls::setQssByFileName(m_map, "FluBorder.qss", this,
...
{
    QString str =
            QString::asprintf("rgb(%d,%d,%d)", bgColor.red(), bgColor.green(), bgColor.blue());
...
{
    QString str = QString::asprintf("rgb(%d,%d,%d)", borderColor.red(), borderColor.green(),
                                    borderColor.blue());
...
{
    QString str = QString::asprintf("rgb(%d,%d,%d)", textColor.red(), textColor.green(),
                                    textColor.blue());
