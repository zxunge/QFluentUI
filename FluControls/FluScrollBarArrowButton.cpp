...
FluScrollBarArrowButton::FluScrollBarArrowButton(
        FluScrollBarArrowButtonType type /*= FluScrollBarArrowButtonType::ArrowUp*/,
...
FluAwesomeTypeNameSpace::FluAwesomeType
FluScrollBarArrowButton::getIconTypeByArrowType(FluScrollBarArrowButtonType type)
{
    switch (type) {
...
void FluScrollBarArrowButton::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawPixmap(rect(),
                       FluIconUtils::getFluentIconPixmap(m_aweSomeType,
